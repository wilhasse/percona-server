...
CapabilitiesGet::~CapabilitiesGet() {
  // @@protoc_insertion_point(destructor:PolarXRPC.Connection.CapabilitiesGet)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<std::string>();
}
...
// @@protoc_insertion_point(message_clear_start:PolarXRPC.Connection.CapabilitiesGet)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* CapabilitiesGet::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:PolarXRPC.Connection.CapabilitiesGet)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:PolarXRPC.Connection.CapabilitiesGet)
  return target;
}

size_t CapabilitiesGet::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:PolarXRPC.Connection.CapabilitiesGet)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:PolarXRPC.Connection.CapabilitiesGet)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:PolarXRPC.Connection.CapabilitiesGet)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
Close::~Close() {
  // @@protoc_insertion_point(destructor:PolarXRPC.Connection.Close)
  if (GetArenaForAllocation() != nullptr) return;
  SharedDtor();
  _internal_metadata_.Delete<std::string>();
}
...
void Close::Clear() {
// @@protoc_insertion_point(message_clear_start:PolarXRPC.Connection.Close)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* Close::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:PolarXRPC.Connection.Close)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:PolarXRPC.Connection.Close)
  return target;
}

size_t Close::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:PolarXRPC.Connection.Close)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:PolarXRPC.Connection.Close)
  GOOGLE_DCHECK_NE(&from, this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:PolarXRPC.Connection.Close)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
