...
class Open_Condition final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:PolarXRPC.Expect.Open.Condition) */ {
 public:
...
class Open final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:PolarXRPC.Expect.Open) */ {
 public:
...
class Close final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:PolarXRPC.Expect.Close) */ {
 public:
