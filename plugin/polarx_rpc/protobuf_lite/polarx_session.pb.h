...
const std::string& KillSession_KillType_Name(KillSession_KillType value);
template<typename T>
inline const std::string& KillSession_KillType_Name(T enum_t_value) {
  ...
  return KillSession_KillType_Name(static_cast<KillSession_KillType>(enum_t_value));
}
...
class AuthenticateStart final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:PolarXRPC.Session.AuthenticateStart) */ {
 public:
...
class AuthenticateContinue final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:PolarXRPC.Session.AuthenticateContinue) */ {
 public:
...
class AuthenticateOk final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:PolarXRPC.Session.AuthenticateOk) */ {
 public:
...
class NewSession final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:PolarXRPC.Session.NewSession) */ {
 public:
...
class KillSession final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:PolarXRPC.Session.KillSession) */ {
 public:
...
class Reset final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:PolarXRPC.Session.Reset) */ {
 public:
...
class Close final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:PolarXRPC.Session.Close) */ {
 public:
