...
static ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<std::string> Scalar_Type_strings[11] = {};
...
static const ::PROTOBUF_NAMESPACE_ID::internal::EnumEntry Scalar_Type_entries[] = {
  ...
  { {Scalar_Type_names + 21, 12}, 10 },
  { {Scalar_Type_names + 33, 6}, 3 },
  { {Scalar_Type_names + 39, 8}, 4 },
  { {Scalar_Type_names + 47, 13}, 9 },
  { {Scalar_Type_names + 60, 12}, 11 },
  { {Scalar_Type_names + 72, 6}, 1 },
  { {Scalar_Type_names + 78, 8}, 8 },
  { {Scalar_Type_names + 86, 6}, 2 },
};
...
bool Scalar_Type_Parse(
  ...
  bool success = ::PROTOBUF_NAMESPACE_ID::internal::LookUpEnumValue(
      Scalar_Type_entries, 11, name, &int_value);
  if (success) {
...
void SessionVariable::CheckTypeAndMergeFrom(
    const ::PROTOBUF_NAMESPACE_ID::MessageLite& from) {
  MergeFrom(*::PROTOBUF_NAMESPACE_ID::internal::DownCast<const SessionVariable*>(
      &from));
}
...
std::string SessionVariable::GetTypeName() const {
