...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_polarx_5fsql_2eproto;
namespace PolarXRPC {
namespace Sql {
class StmtExecute;
...
class StmtExecute final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PolarXRPC.Sql.StmtExecute) */ {
 public:
...
class StmtExecuteOk final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:PolarXRPC.Sql.StmtExecuteOk) */ {
 public:
...
class TokenOffer final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PolarXRPC.Sql.TokenOffer) */ {
 public:
