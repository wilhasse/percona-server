...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_polarx_5fresultset_2eproto;
namespace PolarXRPC {
namespace Resultset {
class Chunk;
...
inline const std::string& ColumnMetaData_OriginalType_Name(T enum_t_value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    ColumnMetaData_OriginalType_descriptor(), enum_t_value);
}
inline bool ColumnMetaData_OriginalType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, ColumnMetaData_OriginalType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<ColumnMetaData_OriginalType>(
    ColumnMetaData_OriginalType_descriptor(), name, value);
}
// ===================================================================

class FetchDoneMoreOutParams final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:PolarXRPC.Resultset.FetchDoneMoreOutParams) */ {
 public:
...
class FetchDoneMoreResultsets final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:PolarXRPC.Resultset.FetchDoneMoreResultsets) */ {
 public:
...
class FetchDone final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PolarXRPC.Resultset.FetchDone) */ {
 public:
...
class ColumnMetaData final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PolarXRPC.Resultset.ColumnMetaData) */ {
 public:
  ...
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  OriginalType_descriptor() {
    return ColumnMetaData_OriginalType_descriptor();
  }
  template<typename T>
...
class Row final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PolarXRPC.Resultset.Row) */ {
 public:
...
class TokenDone final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PolarXRPC.Resultset.TokenDone) */ {
 public:
...
class Chunk final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PolarXRPC.Resultset.Chunk) */ {
 public:
...
class Column final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PolarXRPC.Resultset.Column) */ {
 public:
...
class FixedSizeColumn final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PolarXRPC.Resultset.FixedSizeColumn) */ {
 public:
...
class VariableSizeColumn final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:PolarXRPC.Resultset.VariableSizeColumn) */ {
 public:
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::PolarXRPC::Resultset::ColumnMetaData_FieldType>() {
  return ::PolarXRPC::Resultset::ColumnMetaData_FieldType_descriptor();
}
template <> struct is_proto_enum< ::PolarXRPC::Resultset::ColumnMetaData_OriginalType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::PolarXRPC::Resultset::ColumnMetaData_OriginalType>() {
  return ::PolarXRPC::Resultset::ColumnMetaData_OriginalType_descriptor();
}
