...
/** @file ha_lmdb.h
    ...
    @brief
  The ha_lmdb engine is a stubbed storage engine for lmdb purposes only;
  it does nothing at this point. Its purpose is to provide a source
  code illustration of how to begin writing new storage engines; see also
  /storage/lmdb/ha_lmdb.cc.

    @note
  Please read ha_lmdb.cc before reading this file.
  Reminder: The lmdb storage engine implements all methods that are
  *required* to be implemented. For a full list of all methods that you can
  implement, see handler.h.

   @see
  /sql/handler.h and /storage/lmdb/ha_lmdb.cc
*/
...
/** @brief
  Lmdb_share is a class that will be shared among all open handlers.
  This lmdb implements the minimum of what you will probably need.
*/
...
class ha_lmdb : public handler {
  ...
  */
  /** @brief
    We implement this in ha_lmdb.cc; it's a required method.
  */
  ...
  */
  ...
  /** @brief
    We implement this in ha_lmdb.cc. It's not an obligatory method;
